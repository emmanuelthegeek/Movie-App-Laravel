                    ...
                    @if (count($movie['videos']['results']) > 0)
                        ...
                        @if(Auth::check())
                            <form style="text-align:center;">
                                ...
                                <input type="text" class="form-control" name="posted_by" aria-describedby="emailHelp" placeholder="Your name" required>
                                </div>
                                <div class="form-group" style="max-width:250px; text-align:center;">
                                <label for="exampleInputPassword1">Comments</label>
                                <input type="text" class="form-control" name="comments" placeholder="Type your comments here..." style="width: 250px; height:300px;" required>
                                </div>
                            </form>
                        @endif
